 ...
 * ------------------------ */
     ...
     */
        ...
        int p = setUpFinalBiDiagonal(A, m, e, nct, nrt);

        // If required, generate U.

        generateU(m, nu, u, nct);
    ...
    private void reduceAToBiDiagonal(double[][] a, int m, double[][] u, double[][] v, double[] e, double[] work, int nct, int nrt) {
        for (int k = 0; k < Math.max(nct, nrt); k++) {
            ...
            if ((k < nct)) {
                ...
                placetransofrmationblahblah(a, m, u, k);
            }
            if (k < nrt) {
                computeBlahBlah(a, m, v, e, work, k);
            }
        }
    }
